  ...
  return (
    <input
      ...
      className={cn(
        ...
        "focus-visible:border-c12 focus-visible:ring-c12/50 focus-visible:ring-[3px]",
        "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive text-c12",
        className,
      )}
      {...props}
    />
